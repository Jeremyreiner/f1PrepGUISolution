...
playBtn = "⏯️"
stopBtn = "⏸"
selection = [str(x)[str(x).find(''):4] for x in list(serial.tools.list_ports.comports())]
...
def Make_Win1():
    ...
    win1 = sg.Window(title="Dialog Title", 
                    layout=layout1,
                    resizable=True,
                    icon=r'C:\Users\reine\Downloads\default.ico',
                    finalize=True)
